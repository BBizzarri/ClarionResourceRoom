        ...
        <div class="row row-alignment">
          ...
          <form id="filterForm" action="../controller/controller.php?action=applyFilter&Display=<?php echo $Display?>&CATEGORYID=<?php echo $CATEGORYID?>&DESCRIPTION=<?php echo $DESCRIPTION?>" method="post" enctype="multipart/form-data">
              ...
              <div class="sidebar-elements">
                  ...
                  <input type="checkbox"id="stockedItems" name="stockedItems" onclick="adjustFilters()" <?php if(isset($_POST['stockedItems'])) echo "checked='checked'"; ?> />
              </div>
              <div class="sidebar-elements">
                  <label for="inactiveItems">Include Inactive Items</label>
                  <input type="checkbox" id="inactiveItems" name="inactiveItems" onclick="adjustFilters()" <?php if(isset($_POST['inactiveItems'])) echo "checked='checked'"; ?> />
              </div>
              <div class="sidebar-elements">
                  <label for="shoppingList">Show Shopping List</label>
            ...
            <div class="sidebar-elements">
                  ...
                  <ul class="nav flex-column">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="category nav-link <?php if($Display == 'category'){ echo 'category-selected'; }?>" id="singleCategory_<?php echo $category->getCategoryID()?>" href="../controller/controller.php?action=displaySelectedCategory&CATEGORYID=<?php echo $category->getCategoryID()?>&DESCRIPTION=<?php echo htmlspecialchars($category->getCategoryDescription())?>&Display=<?php echo 'category' ?>"><?php echo htmlspecialchars($category->getCategoryDescription()) ?></a>
                        </li>
                    <?php
                    }
                    ?>
